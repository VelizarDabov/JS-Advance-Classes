...
log(c.addEmployee("Stanimir", 2000, "engineer", "Construction"));

log(c.addEmployee("Pesho", 1500, "electrical engineer", "Construction"));

log(c.addEmployee("Slavi", 500, "dyer", "Construction"));

log(c.addEmployee("Stan", 2000, "architect", "Construction"));

log(c.addEmployee("Stanimir", 1200, "digital marketing manager", "Marketing"));

log(c.addEmployee("Pesho", 1000, "graphical designer", "Marketing"));

log(c.addEmployee("Gosho", 1350, "HR", "Human resources"));
